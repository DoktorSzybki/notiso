...
var redis = new ioredis_1.default(parseInt(process.env.REDISPORT), process.env.REDIS);
redis.subscribe("event", function (error, count) {
    if (error) {
...
redis.on("message", function (channel, message) { return __awaiter(void 0, void 0, void 0, function () {
    var event_1, error_1;
